...
local button_color = Color(40, 40, 40)
local text_color = Color(0, 195, 165)
local button_hover_color = Color(0, 195, 165)
local text_hover_color = Color(40, 40, 40)
...
function ToggleEscapeMenu()
    if IsValid(ESCAPE_FRAME) and ESCAPE_FRAME:IsVisible() then 
        ...
        return
    elseif IsValid(ESCAPE_FRAME) and not ESCAPE_FRAME:IsVisible() then
