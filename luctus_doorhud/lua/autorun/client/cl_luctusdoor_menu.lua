...
--This is basically the cl_menu.lua from the default DarkRP keys copied and changed to a different design

local function AddButtonToFrame(Frame)
    Frame:SetTall(Frame:GetTall() + 60)

    local button = vgui.Create("DButton", Frame)
    button:SetPos(10, Frame:GetTall() - 60)
